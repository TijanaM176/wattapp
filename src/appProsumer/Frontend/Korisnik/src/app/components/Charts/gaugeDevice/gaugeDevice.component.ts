...
@Component({
  selector: 'app-gaugeDevice',
  templateUrl: './gaugeDevice.component.html',
  styleUrls: ['./gaugeDevice.component.css'],
})
export class GaugeDeviceComponent implements OnInit, AfterViewInit {
