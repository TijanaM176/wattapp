...
export class ResetPasswordService {
  ...
  forgotPass(email:string){
    return this.http.post<ForgotPassword>(`${this.baseUrl}forgot_passwordProsumer?email=`+email,{});
  }
  ...
  resetPassword(resetPasswordObj:ResetPassword){
    return this.http.post<any>(`${this.baseUrl}reset_passwordProsumer`,resetPasswordObj);
  }
}
