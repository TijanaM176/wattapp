...
namespace API.Services.Devices
{
    public interface IDevicesService
    {
        ...
        public Task<Dictionary<DateTime, double>> GroupedConsumptionForAPeriodForProsumer(string id, int period);
        public Task<Dictionary<DateTime, double>> ProductionForAPeriodForProsumer(string id, int period);
        public Task<Dictionary<DateTime, double>> GroupedProductionForAPeriodForProsumer(string id, int period);
